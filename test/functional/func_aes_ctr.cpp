...
{
    std::cout << "AES-CTR Test" << std::endl;
    ...
    for (size_t i=0; i < 3; i++) {
        ...
        symmetric_key_type_e key_type = (0 == i) ? SYMKEY_AES_128_CTR :
                                        (1 == i) ? SYMKEY_AES_192_CTR
                                                 : SYMKEY_AES_256_CTR;
        ...
        std::cout << "AES-CTR length=" << static_cast<int>(num_bytes) << std::endl;
