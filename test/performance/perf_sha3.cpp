...
json perf_sha3::run(size_t duration_us)
{
    std::cout << "  CRYPTOGRAPHIC HASH :: SHA3" << std::endl;
    ...
    do {
        ...
        switch (hash_type)
        {
            case 0: type = HASH_SHA3_224; hash_name = "SHA3-224"; break;
            case 1: type = HASH_SHA3_256; hash_name = "SHA3-256"; break;
            case 2: type = HASH_SHA3_384; hash_name = "SHA3-384"; break;
            case 3: type = HASH_SHA3_512; hash_name = "SHA3-512"; break;
        }
