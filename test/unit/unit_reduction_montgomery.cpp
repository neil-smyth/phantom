...
{
    CASE("Reduction - Montgomery")
    {
        montgomery<uint16_t> r(montgomery<uint16_t>(12289, 12289 - 2, 12, 4091, 10952));
        reduction<reduction_montgomery<uint16_t>, uint16_t> red(r);
        uint16_t result;
        result = red.reduce(0);
        EXPECT(0 == result);
        result = red.reduce(1);
    ...
    CASE("Divide - Montgomery")
    {
        montgomery<uint16_t> r(montgomery<uint16_t>(12289, 12289 - 2, 12, 4091, 10952));
        reduction<reduction_montgomery<uint16_t>, uint16_t> red(r);
        uint16_t result;
        result = red.div(red.convert_to(10000), red.convert_to(1));
        EXPECT(red.convert_to(10000) == result);
        result = red.div(red.convert_to(12289), red.convert_to(1));
        EXPECT(red.convert_to(0) == result);
        result = red.div(red.convert_to(12288), red.convert_to(2));
        EXPECT(red.convert_to(6144) == result);
    },
    CASE("Inverse - Montgomery")
    {
        montgomery<uint16_t> r(montgomery<uint16_t>(12289, 12289 - 2, 12, 4091, 10952));
        reduction<reduction_montgomery<uint16_t>, uint16_t> red(r);
        uint16_t result;
    ...
    CASE("Negate - Montgomery")
    {
        ...
        result = red.negate(1);
        EXPECT(result == 12288);
        result = red.negate(12288);
        EXPECT(result == 1);
    },
    CASE("Right shift 1 bit - Montgomery")
    {
        montgomery<uint16_t> r(montgomery<uint16_t>(12289, 12289 - 2, 12, 4091, 10952));
        reduction<reduction_montgomery<uint16_t>, uint16_t> red(r);
        uint16_t result;
    ...
    CASE("Left shift 1 bit - Montgomery")
    {
        montgomery<uint16_t> r(montgomery<uint16_t>(12289, 12289 - 2, 12, 4091, 10952));
        reduction<reduction_montgomery<uint16_t>, uint16_t> red(r);
        uint16_t result;
