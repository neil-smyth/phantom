...
const lest::test specification[] =
{
    CASE("Jacobian point - 32-bit")
    {
        ...
        weierstrass_binary_jacobian<uint32_t> p(cfg, x, y);
    ...
    CASE("Jacobian point doubling - 32-bit")
    {
        ecc_config<uint32_t> cfg;
        cfg.mod.mod = mpz<uint32_t>(p163, 16);
        cfg.mod.mod_inv = mpz<uint32_t>(p163_inv, 16);
    ...
    CASE("Jacobian point doubling using addition - 32-bit")
    {
        ecc_config<uint32_t> cfg;
        cfg.mod.mod = mpz<uint32_t>(p163, 16);
        cfg.mod.mod_inv = mpz<uint32_t>(p163_inv, 16);
        ...
        weierstrass_binary_jacobian<uint32_t> pbase(cfg, x, y);
        weierstrass_binary_jacobian<uint32_t> p(cfg, x, y);
    ...
    CASE("Jacobian point doubling repeated - 32-bit")
    {
        ecc_config<uint32_t> cfg;
        cfg.mod.mod = mpz<uint32_t>(p163, 16);
        cfg.mod.mod_inv = mpz<uint32_t>(p163_inv, 16);
    ...
    CASE("Jacobian point doubling and addition - 32-bit")
    {
        ecc_config<uint32_t> cfg;
        cfg.mod.mod = mpz<uint32_t>(p163, 16);
        cfg.mod.mod_inv = mpz<uint32_t>(p163_inv, 16);
    ...
    CASE("Jacobian point doubling and subtraction - 32-bit")
    {
        ecc_config<uint32_t> cfg;
        cfg.mod.mod = mpz<uint32_t>(p163, 16);
        cfg.mod.mod_inv = mpz<uint32_t>(p163_inv, 16);
