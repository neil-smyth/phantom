...
private:
    ...
    void uniform_random_ring_q(dilithium* dil, uint8_t *seed,
                               uint16_t nonce, int32_t *a, size_t n, uint32_t q) const;
    ...
    void create_rand_product(ctx_dilithium& ctx, uint8_t *seed, uint32_t q,
    ...
    void expand_A(ctx_dilithium& ctx, uint8_t *seed, uint32_t q, int32_t *A, size_t n,
